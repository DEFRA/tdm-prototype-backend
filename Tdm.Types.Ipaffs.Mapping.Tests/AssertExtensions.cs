...
namespace Tdm.Types.Ipaffs.Mapping.Tests;
...
public static class AssertExtensions
{
    ...
    public static void ShouldBeEqualTo(this Tdm.Model.Ipaffs.Notification notification, Tdm.Model.Ipaffs.IpaffsNotificationTypeEnum notificationType, Tdm.Model.Ipaffs.IpaffsNotificationStatusEnum status, string expectedJson)
    {
