...
public class MovementResource(IResourceGraph resourceGraph, ITdmClaimsProvider tdmClaimsProvider) : JsonApiResourceDefinition<Movement, string>(resourceGraph)
{
        ...
        SparseFieldSetExpression? existingSparseFieldSet)
    {
        if (existingSparseFieldSet != null)
        {
            ...
            //         .Excluding<Movement>(n => n._PointOfEntry, ResourceGraph)
            //         .Excluding<Movement>(n => n._PointOfEntryControlPoint, ResourceGraph);
            ...
            {
                existingSparseFieldSet = existingSparseFieldSet
                    .Excluding<Movement>(n => n.AuditEntries, ResourceGraph);
            }
        }
    ...
    // TODO : need to figure out how we filter out data that a PHA can see
    ...
    //             n.Property.Name == nameof(Movement._PointOfEntry));
    //     
